...
public class DataFetcher {
    ...
    // --- Vacances ---
    public List<Vacances> getVacances() {
        return vacancesRepository.findAll();
    }

    @SuppressWarnings("null")
    public Vacances getVacances(Integer id) {
        return vacancesRepository.getReferenceById((long) id);
    }
